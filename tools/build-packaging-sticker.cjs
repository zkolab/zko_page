...
const homepage = 'https://zkolab.com/';
...
<svg width="2400" height="1440" viewBox="0 0 2400 1440" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="title desc">
  ...
  <desc id="desc">字库 AI 编程手柄包装贴纸，主页 ${homepage}</desc>
  <defs>
  ...
  <text x="150" y="930" fill="#FFFFFF" font-family="Microsoft YaHei, Noto Sans CJK SC, sans-serif" font-size="126" font-weight="700">字库 AI 编程手柄</text>
  ...
  <text x="1952" y="1005" text-anchor="middle" fill="#79DCE3" font-family="Arial, sans-serif" font-size="64" font-weight="600">
    <tspan x="1952" textLength="520" lengthAdjust="spacingAndGlyphs">zkolab.com</tspan>
  </text>
</svg>`;
